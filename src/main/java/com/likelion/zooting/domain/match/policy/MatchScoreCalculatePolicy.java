 ...
 * <tr><td>관심사</td><td>개별 관심사당 10점 부여</td><td>30점</td></tr>
 * <tr><td>영화 장르</td><td>개별 장르당 5점 부여</td><td>10점</td></tr>
 * </table>
 *
 * <p><b>2. 최소 요구 조건 (필터링)</b></p>
 * <ul>
 * <li>동물상, 관심사, 영화 장르 세 가지 항목 모두 <b>최소 1개 이상</b> 선택해야 합니다.</li>
 * <li>위 조건을 만족하지 않는 사용자는 해당 항목의 점수가 0점 처리됩니다.</li>
 * </ul>
 *
 * <p><b>3. 동물상 매칭 세부 규칙 (단방향성)</b></p>
 * <ul>
...
public interface MatchScoreCalculatePolicy {
     ...
     * <p><b>[점수 산정 로직]</b></p>
     * <ul>
     * <li>개별 관심사당 10점씩 부여하며, 최대 3개의 관심사(총 30점)를 가집니다.</li>
     * <li>관심사를 최소 하나 이상 선택한 사용자만 매칭 후보가 되며, 미선택 시 0점으로 처리됩니다.</li>
     * </ul>
     *
     ...
     * <p><b>[점수 산정 로직]</b></p>
     * <ul>
     * <li>장르당 5점씩 부여하며, 최대 2개의 장르(총 10점)를 가집니다.</li>
     * <li>영화 장르를 최소 하나 이상 선택해야 하며, 일치하는 장르가 없을 경우 0점으로 유지됩니다.</li>
     * </ul>
     *
     * <p><b>[참조 사항]</b></p>
